...
|---|---|---|---|
| `creativity_roster` | scheduling, one turn impossible | 6 | `tests/roster.py` |
| `creativity_merge` | merging messy data | 6 | `tests/merge_check.py` |
| `creativity_labindex` | cleaning an index, fast | 5 | `tests/lab_check.py` |
