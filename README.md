...
OpenAI-compatible endpoints from OpenAI, Anthropic and Google.
    ...
    ./run.py scenarios/_preflight --url http://127.0.0.1:8080 --model local
    ./run.py scenarios/_preflight --url https://openrouter.ai/api \
...
## Layout
    ...
    harness/
      ...
      fakes.py     scripted fake model and fake llama.cpp server, for tests
    scenarios/
    ...
    tests/         pytest; uses harness/fakes.py (fake model + fake llama.cpp server)
    preflight.py
    run.py
    lint.py
